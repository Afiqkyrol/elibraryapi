...
public class BorrowedList {
    ...
    public BorrowedList(int book_id, int history_id, String book_title, String borrower, Date date_borrowed, Date est_date_to_return, Date act_date_return, Date extend_date, String status_extend) {
