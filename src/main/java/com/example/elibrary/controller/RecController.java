...
//            StUserRole mmdis_user_role = stUserRoleRepository.getUserRoleByGuidAndModuleId(mmdis_user.getGuid(), 41); //kena ubah module id
...
//                if(mmdis_user_role.getRole_id() == 1){
//                    user.setRole_id(1);
//                    user.setRole(ADMIN);
//                }else if(mmdis_user_role.getRole_id() == 2){
//                    user.setRole_id(2);
//                    user.setRole(PATRON);
//                }else if(mmdis_user_role.getRole_id() == 3){
//                    user.setRole_id(3);
//                    user.setRole(LIBRARIAN);
//                }
                user.setRole_id(1);//boleh delete nanti
                ...
                user.setRole(LIBRARIAN);// boleh delete nanti
